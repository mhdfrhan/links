...
// SocialLink interface matches what we have in Firestore
...
const getPlatformIcon = (platform: string) => {
  switch (platform.toLowerCase()) {
    ...
    case "tiktok": return <span className="text-xl">🎵</span>;
    case "email": return <span className="text-xl">📧</span>;
...
export function SocialLinks({ links = [] }: SocialLinksProps) {
  // Fallback to static data if no dynamic links provided (for initial load)
  const displayLinks = links.length > 0 ? links.sort((a, b) => a.order - b.order) : [
