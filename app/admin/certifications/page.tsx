  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl lg:text-2xl font-semibold text-foreground tracking-tight">Sertifikasi</h1>
                      ...
                      <div className="pl-6 md:pl-8">
                        ...
                        {item.verifyUrl && (
                          <a 
                            ...
                            className="inline-flex items-center gap-1 mt-3 px-2 py-1 bg-accent/5 text-[10px] font-semibold text-accent rounded-md border border-accent/10 hover:bg-accent/10 transition-colors relative z-20"
                          >
